    ...
    if old == False and new == True:
        ...
        for config in next_deployment_configs:
            if config.get("kind") == "Deployment":
                ...
                annotations_patch["metadata"]["annotations"]["child-deployment-app-name"] = next_deployment_app_name
        ...
        data = {
            ...
            "endpoints": [
                {
                    "variable_name": "_STATE",
                    "endpoint": "/led_state"
                },
                {
                    "variable_name": "_POWER_CONSUMPTION",
                    "endpoint": "/power_consumption"
                }
            ]
        }
